    ...
    <body>
        ...
        <section style="margin-top: 80px;">
            <div style="width: 74%; margin: 0 auto;">
                ...
                <div class="circle">
                    <img src="https://akademiasmaku.pl/upload/vademecums/677/big/mobile/jak-dobrac-skladniki-czyli-sekret-udanej-salatki-677.jpg" alt="">
                </div>
            </div>
        </section>
        <br style="clear: both">
        <footer>
            <span>my recipes &copy; 2020r.</span>
            <p style="color: white">Lorem ipsum dolor, sit amet consectetur adipisicing<br>
                 Odit numquam sint perferendis ut non, aperiam excepturi <br>
                  accusantium deleniti consequatur eligendi <br>
                voluptatem debitis et, incidunt molestias ratione <br>
                 tempora temporibus molestiae reprehenderit!</p>
        </footer>
        @endsection
    </body>
</html>
